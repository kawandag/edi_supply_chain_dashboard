...
4. Set **Main file path** to `supply_chain_streamlit_project/app.py`.
5. Select **Deploy**.

No secrets or environment variables are required. Dependencies are installed automatically from `supply_chain_streamlit_project/requirements.txt`.
